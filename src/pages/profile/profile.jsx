    ...
    <div className="min-h-screen text-white p-4 flex flex-col items-center">
      <div className="w-full max-w-7xl flex flex-col md:flex-row gap-8 ">
        ...
        <form onSubmit={handleSubmit} className="md:w-2/3 w-full">
          <fieldset
            className=" rounded-lg p-6 space-y-6 bg-[#fff]"
            // style={{
            //   background: `linear-gradient(165deg, #20934a 0%, #21936a 40%, #26a69a 100%)`,
            // }} //#20934a
          >
            <legend className="text-2xl font-semibold px-2 text-[#084e54]">
              Profile Details
            </legend>
            ...
            <div className="flex justify-center items-center gap-12">
              <div className="w-32">
                <label
                  ...
                  className="block text-sm font-medium mb-2 text-center text-[#000]"
                >
                  Profile Picture *
                </label>
                <div className="border border-[#26a69a] rounded-full bg-white/10 flex flex-col items-center justify-center cursor-pointer hover:border-[#4ecdc4] transition w-32 h-32 mx-auto">
                  <input
                    id="profilePicture"
                    type="file"
                    name="profilePicture"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={field}>
                  <label
                    htmlFor={field}
                    className="block text-sm font-medium mb-1 capitalize text-[#26a69a]"
                  >
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder={`Enter your ${field}`}
                    className={`w-full px-3 py-2 rounded border border-[black]/10 bg-white/10 text-[#000] placeholder-[gray]/40 focus:outline-none focus:ring-2
                      ${
                        errors[field]
              ...
              <div>
                <input
                  type="submit"
                  value="Update Profile"
                  className="mt-5 bg-[#26a69a] hover:bg-[#1e857b] flex justify-center text-white font-semibold px-6 py-3 rounded-full hover:from-[#0a5c64] hover:to-[#5dd5cd] transition w-full max-w-xs mx-auto cursor-pointer"
                />
              </div>
            </div>
          </fieldset>
        ...
        <form className="md:w-1/3 w-full">
          <fieldset className="rounded-lg p-6 space-y-6 border border-white/20 bg-[#fff]" 
          // style={{
          //     background: `linear-gradient(165deg, #20934a 0%, #21936a 40%, #26a69a 100%)`,
          //   }} 
            >
            ...
            <p className="text-sm text-white/70 mb-4 text-[#000]">
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium mb-1 text-[#26a69a]"
              >
                Current Password *
              </label>
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Enter current password"
                  className={`w-full px-3 py-2 rounded border border-[black]/10 bg-white/10 text-[#000] placeholder-[gray]/40 pr-10 focus:outline-none focus:ring-2
                    ${
                      passwordErrors.currentPassword
                        ? "border-red-500 ring-red-500"
                        : "border-white/20 ring-[#4ecdc4]"
                ...
                <button
                  type="button"
                  onClick={togglePasswordVisibility}
                  className="absolute right-3 top-2.5 text-white hover:text-[#4ecdc4]"
                  aria-label={showPassword ? "Hide password" : "Show password"}
                >
                  {showPassword ? "🙈" : "👁️"}
                </button>
            ...
            <div className="flex gap-3 items-center">
              <div className="flex-grow">
                <label htmlFor="otp" className="block text-sm font-medium mb-1 text-[#26a69a]">
                  OTP *
                </label>
                <input
                  id="otp"
              ...
              <button
                type="button"
                onClick={GetOtp}
                className="h-10 mt-5 px-5 bg-[#26a69a] text-white rounded-full font-semibold hover:bg-[#1e857b] whitespace-nowrap"
              >
                Get OTP
              </button>
            </div>
            ...
            <button
              type="button"
              onClick={handleVerifyOTP}
              className="w-full mt-4 bg-[#26a69a] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#1e857b]"
            >
              Verify OTP
            </button>
